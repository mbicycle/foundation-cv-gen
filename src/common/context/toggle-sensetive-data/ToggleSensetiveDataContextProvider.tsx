...
const ToggleSensetiveDataContextProvider: React.FC<React.PropsWithChildren> = function ({ children }): JSX.Element {
  ...
  return (
    <ToggleSensetiveDataContext.Provider value={projectContextValue}>{children}</ToggleSensetiveDataContext.Provider>
  )
}
